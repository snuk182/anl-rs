...
impl ImplicitModule for ImplicitTranslateDomain {
	...
	fn get_3d(&mut self, x: f64, y: f64, z: f64) -> f64 {
		self.source.get_3d(x+self.ax.get_3d(x, y, z), y+self.ay.get_3d(x, y, z), z+self.az.get_3d(x, y, z))
	}
	fn get_4d(&mut self, x: f64, y: f64, z: f64, w: f64) -> f64 {
		self.source.get_4d(x+self.ax.get_4d(x, y, z, w), y+self.ay.get_4d(x, y, z, w), z+self.az.get_4d(x, y, z, w), w+self.aw.get_4d(x, y, z, w))
	}
	fn get_6d(&mut self, x: f64, y: f64, z: f64, w: f64, u: f64, v: f64) -> f64 {
		self.source.get_6d(x+self.ax.get_6d(x, y, z, w, u, v), y+self.ay.get_6d(x, y, z, w, u, v), z+self.az.get_6d(x, y, z, w, u, v),
			w+self.aw.get_6d(x, y, z, w, u, v), u+self.au.get_6d(x, y, z, w, u, v), v+self.av.get_6d(x, y, z, w, u, v))
	}
